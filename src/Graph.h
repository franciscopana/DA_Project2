...
public:
     ...
     * 
     * @details Time complexity: O(N + M), where N is the number of nodes and M is the number of edges
     */
    void load();
     ...
     *
     * @details Time complexity: O((N-1)!), where N is the number of nodes
     */
     ...
     *
     * @details Time complexity:  O((V + E) log V), where V is the number of vertices and E is the number of edges
     */
     ...
     *
     * @details Time complexity: O(N), where N is the number of nodes in the MST
     */
    ...
    /**
     * @brief Solves the Traveling Salesman Problem (TSP) using the Cheapest Insertion algorithm.
     *
     * @return A pair consisting of the cost of the tour and the vector of node indices representing the tour.
     *
     * @details Time complexity: O(N^3), where N is the number of nodes in the graph
     */
    pair<double, vector<unsigned int>> TSP_CheapestInsertion();
     ...
     *
     * @details Time complexity: O(P) being P the size of the path
     */
